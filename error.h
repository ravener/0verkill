...
// TODO: Find a purpose for this functions or get rid of them.

static inline void *debug_mem_alloc(char *f, int l, size_t s) {
  (void)f;
  (void)l;
  (void)s;
...
static inline void *debug_mem_calloc(char *f, int l, size_t s) {
  (void)f;
  (void)l;
  (void)s;
  return mem_calloc(s);
...
static inline void debug_mem_free(char *f, int l, void *p) {
  (void)f;
  (void)l;
  (void)p;
...
static inline void *debug_mem_realloc(char *f, int l, void *p, size_t s) {
  (void)f;
  (void)l;
  (void)p;
  (void)s;

  return mem_realloc(p, s);
}
